...
parser.add_argument('--save', default='./tsne_vis/resnet20_shiftadd_FIX8', type=str, metavar='PATH', help='path to save prune model')
...
parser.add_argument('--quantize_v', type=str, default='wageubn', help='quantize version')
