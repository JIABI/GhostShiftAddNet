...
__all__ = ['resnet34_add', 'resnet18_add']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, quantize=False, weight_bits=8, sparsity=0):
...
def resnet18_add(num_classes=1000, quantize=False, weight_bits=8, sparsity=0, **kwargs):
    model = ResNet(BasicBlock, [2, 2, 2, 2], quantize=quantize, weight_bits=weight_bits, sparsity=sparsity, **kwargs)
    return model

def resnet34_add(num_classes=1000, quantize=False, weight_bits=8, sparsity=0, **kwargs):
    model = ResNet(BasicBlock, [3, 4, 6, 3], quantize=quantize, weight_bits=weight_bits, sparsity=sparsity, **kwargs)
    return model

def resnet50_add(num_classes=1000, quantize=False, weight_bits=8, sparsity=0, **kwargs):
