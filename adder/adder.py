...
adder_cuda = load(
  'adder_cuda', ['/home/bella/Desktop/ShiftAddNet/adder/adder_cuda.cpp', '/home/bella/Desktop/ShiftAddNet/adder/adder_cuda_kernel.cu'], verbose=True)
...
class Adder2D(nn.Module):
    def __init__(self,
                 ...
                 eta = 0.2,
                 groups =1,
                 quantize=True, weight_bits=8, sparsity=0, momentum=0.9, quantize_v='sbm'):
