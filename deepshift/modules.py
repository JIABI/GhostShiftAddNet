...
class Conv2dShiftFunction(Function):
    ...
    @staticmethod
    # bias is an optional argument
    def forward(ctx, input, shift, sign, bias=None, conc_weight=None, stride=1, padding=0, dilation=1, groups=input, use_kernel=False, use_cuda=False, rounding='deterministic', shift_range=(-14, 0)):
        fraction_bits = 16
        integer_bits = 16
...
class _ConvNdShift(nn.Module):
    ...
    def reset_parameters(self, weight_bits):
        ...
        #self.shift.data.uniform_(-self.shift_range, -1)  # (-0.1, 0.1)
...
class Conv2dShift(_ConvNdShift):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 ...
                 check_grad=False, freeze_sign=False, use_kernel=True, use_cuda=True, rounding='determinstic', weight_bits=5, threshold=0.3, quant_bits=16):
