...
from sklearn.metrics._classification import accuracy_score, recall_score, f1_score
...
from se_shift.alg_structural import smart_decompose
...
parser.add_argument('--dataset', type=str, default='MHEALTH', help='training dataset')
parser.add_argument('--arch', default='CNN_shiftadd_se ', type=str, help='architecture to use')
parser.add_argument('--momentum', type=float, default=0.9, metavar='M', help='SGD momentum')
parser.add_argument('--weight-decay', '--wd', default=1e-4, type=float, metavar='W', help='weight decay')
parser.add_argument('--schedule', type=int, nargs='+', default=[20, 30], help='learning rate schedule')
...
parser.add_argument('--save', default='./rebuttal/MHEALTH/CNN_shiftadd_se/FP32', type=str, metavar='PATH', help='path to save prune model')
...
parser.add_argument('--shift_quant_bits', type=int, default=-1, help='quantization training for shift layer')
...
if args.dataset == 'MHEALTH':
    data_input_file = 'D:/ShiftAddNet/IoT/MHEALTH.npz'
...
def get_model():
    if not 'se' in args.arch:
        ...
        model = models.__dict__['CNN_shiftadd_se'](threshold=threshold, sign_threshold=sign_threshold, distribution=distribution,
